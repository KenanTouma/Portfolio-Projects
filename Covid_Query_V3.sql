...
SELECT date, location, people_fully_vaccinated/population*100 AS perc_pop_vaccinated
FROM [Portolio Project - Covid]..CovidVaccinations$
WHERE location = 'canada' or location =  'france' or location = 'Australia' or location = 'United States' or location = 'New Zealand'
